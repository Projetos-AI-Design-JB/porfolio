...
export default function StarForgePage() {
  ...
  const handleInitiateScan = () => {
    setIsScanning(true);
    // This will trigger the camera animation inside Universe component via props/event
  };

  return (
    <main className="relative w-full h-screen overflow-hidden bg-black text-white font-syne">
      {/* 3D UNIVERSE LAYER */}
      <Universe isScanning={isScanning} />
      ...
      <div className="absolute inset-0 z-10 pointer-events-none flex flex-col justify-between p-8 md:p-12">
        <div className="flex justify-between items-start">
          ...
          >
            ...
            <div className="text-sm font-mono text-cyan-400">{isScanning ? "LOCKED // SCANNING..." : "0.00.12.8 // NGC-442"}</div>
          </motion.div>
        </div>
          ...
          <div className="flex flex-col items-center mb-12">
            ...
            >
               <button 
                ...
                className="px-8 py-3 rounded-full border border-cyan-500/30 bg-cyan-500/5 text-cyan-400 hover:bg-cyan-500/20 transition-all backdrop-blur-md active:scale-95"
              >
                  INITIATE SCAN
               </button>
            </motion.div>
